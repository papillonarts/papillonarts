...
// const getStorybookMainSetup = require('@papillonarts/setup/storybook').getStorybookMainSetup

function isEmptyObject(obj) {
	return obj && Object.keys(obj).length === 0 && Object.getPrototypeOf(obj) === Object.prototype
}

function getStorybookMainSetup({ storiesBasePath, includeBasePath, modulesBasePath }) {
